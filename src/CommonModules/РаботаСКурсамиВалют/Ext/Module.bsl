...
Функция ИспользоватьАльтернативныйСерверДляЗагрузкиКурсовВалют() Экспорт
	Возврат Константы.ИспользоватьАльтернативныйСерверДляЗагрузкиКурсовВалют.Получить();
КонецФункции

Функция ИспользоватьАльтернативныйСерверЦБДляЗагрузкиКурсовВалют() Экспорт
	Возврат Константы.ИспользоватьАльтернативныйСерверЦБДляЗагрузкиКурсовВалют.Получить();
КонецФункции
