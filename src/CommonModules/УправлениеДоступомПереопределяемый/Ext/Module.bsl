...
Процедура ПриЗаполненииСписковСОграничениемДоступа(Списки) Экспорт
	...
	Списки.Вставить(Метаданные.Документы.ЭД_ЭлектронныйДокумент, Истина);
...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	ОписанияПрофилей.Добавить(ОписаниеПрофиля_БазовыеПрава());
	ОписанияПрофилей.Добавить(ОписаниеПрофиля_ПользовательФЛ());
	ОписанияПрофилей.Добавить(ОписаниеПрофиля_ПользовательГО());
	
	ЗаполнитьИдентификаторы(ОписанияПрофилей);
...
Процедура ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание) Экспорт
	...
	Описание = Описание + "
		|Документ.ЭД_ЭлектронныйДокумент.Чтение.Организации
		|Документ.ЭД_ЭлектронныйДокумент.Изменение.Организации";
...
Функция ОписаниеПрофиля_БазовыеПрава() Экспорт
	
	// Профиль "Базовые права".
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();;
	ОписаниеПрофиля.Имя = "БазовыеПрава";
	ОписаниеПрофиля.Наименование  =
		НСтр("ru = 'Базовые права'", ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Описание =
		НСтр("ru = 'Профиль групп доступа, дающий пользователю возможность работы с базовыми объектами системы.
			|
...
Функция ОписаниеПрофиля_ПользовательФЛ() Экспорт
	
	// Профиль "Работа с электронными документами".
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();;
	ОписаниеПрофиля.Имя = "ПользовательФЛ";
	ОписаниеПрофиля.Наименование  =
		НСтр("ru = 'Пользователь ФЛ'", ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Описание =
		НСтр("ru = 'Профиль групп доступа, дающий пользователю возможность работы с электронными документами на уровне филиала.'");
	...
	// функциональные роли
	ОписаниеПрофиля.Роли.Добавить("ЧтениеНСИ");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеЭлектронногоДокумента");
...
Функция ОписаниеПрофиля_ПользовательГО() Экспорт
	
	// Профиль "Работа с электронными документами".
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();;
	ОписаниеПрофиля.Имя = "ПользовательГО";
	ОписаниеПрофиля.Наименование  =
		НСтр("ru = 'Пользователь ГО'", ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Описание =
		НСтр("ru = 'Профиль групп доступа, дающий пользователю возможность работы с электронными документами всех организаций.'");
...
Процедура ЗаполнитьИдентификаторы(ОписанияПрофилей)
	
	ПоставляемыеПрофили = ИдентификаторыПоставляемыхПрофилейГруппДоступа();
	
	Для Каждого ОписаниеПрофиля Из ОписанияПрофилей Цикл
		Если ПоставляемыеПрофили.Свойство(ОписаниеПрофиля.Имя) Тогда 
			ОписаниеПрофиля.Идентификатор = ПоставляемыеПрофили[ОписаниеПрофиля.Имя];
		КонецЕсли; 
	КонецЦикла;
	
КонецПроцедуры

Функция ИдентификаторыПоставляемыхПрофилейГруппДоступа()
	
	Перем Профили;
	
	Профили = Новый Структура;
	
	Профили.Вставить("БазовыеПрава",   "51ba6df0-9a82-11ea-816d-3c4a9271083c");
	Профили.Вставить("ПользовательФЛ", "87374657-9aa2-11ea-816d-3c4a9271083c");
	Профили.Вставить("ПользовательГО", "8e146c94-9aa2-11ea-816d-3c4a9271083c");
	
	Возврат ОбщегоНазначения.ФиксированныеДанные(Профили);
