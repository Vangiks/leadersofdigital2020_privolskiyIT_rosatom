...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Имя    = "ЕПЦО";
	Описание.Версия = "1.0.1.0"; // для первой версии в следующем квартале увеличьте третью цифру на 1, а четвертую установите в 1
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыЕПЦО.ПервыйЗапуск";
		
	// Обработчики, выполняемые при каждом обновлении ИБ
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "*";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыЕПЦО.ПереходНаВерсию_Любую";
...
Процедура ПриДобавленииОбработчиковПереходаСДругойПрограммы(Обработчики) Экспорт
	Константы.ЗаголовокСистемы.Установить(Метаданные.Синоним);	
КонецПроцедуры
...
//
Процедура ПервыйЗапуск(ПараметрыОбработчика = Неопределено) Экспорт
	...
	Константы.КоличествоПотоковОбновленияДоступа.Установить(3);
	Константы.ИспользоватьАльтернативныйСерверДляЗагрузкиКурсовВалют.Установить(Истина);
	
КонецПроцедуры

Процедура ПереходНаВерсию_Любую(ПараметрыОбработчика = Неопределено) Экспорт
